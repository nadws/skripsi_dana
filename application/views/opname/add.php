                              ...
                              <table  class="table table-bordered table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" width="50px" name="qty_aktual[]" class="form-control" value="<?= $barang->masuk - $barang->keluar ?>">
                                            <input type="hidden" width="50px" name="qty_program[]" class="form-control" value="<?= $barang->masuk - $barang->keluar ?>">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ket[]" width="100px">
                                            <input type="hidden" value="<?= $barang->kode ?>" name="kode[]" width="100px">
                                            
                                        </td>
                                    </tr>
                                        <?php endforeach; ?>
                                        <input type="hidden" value="OPNM-<?= $nota ?>" name="no_nota_opname" width="100px">
                                     
                                  </tbody>
                              </table>
                          </div>
                          <div class="card-footer">
                            <a href="<?= base_url('opname') ?>" class="btn btn-secondary">Batal</a>
