      ...
      <div class="content">
          <div class="container-fluid">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="card">
                          <div class="card-header">
                              ...
                              <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#tambah_data">Tambah Stok</button>
                          </div>
                          <div class="card-body">
                              <table id="example2" class="table table-bordered table-striped">
                                  ...
                                  <tbody>
                                      <?php foreach ($stok_masuk as $no => $c) : ?>
                                          <tr>
                                              <td><?= $no + 1 ?></td>
                                              <td><?= date('d-m-Y',strtotime($c->tgl))  ?></td>
                                              <td><?= $c->no_nota_masuk ?></td>
                                              <td><?= $c->admin ?></td>
                                              <td><a href="<?= base_url("stok_masuk/detail?no_nota=$c->no_nota_masuk") ?>" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                                          </tr>
                                      <?php endforeach ?>
                                  </tbody>
                              </table>
                  ...
                  <form action="<?= base_url('stok_masuk/add') ?>" method="get" >
